...
export class CanvasGrid implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    inputSchema: string;
    eventRow: any;
    columnProperties: Record<string, JSONSchema4>;
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
        ...
        if (resetPaging || datasetChanged || !this.records) {
